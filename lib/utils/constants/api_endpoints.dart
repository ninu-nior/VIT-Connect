...
const String addFoundItem = "$url/add_found_item";
const String deleteFoundItem = "$url/delete_found_item";

const String addLostItem = "$url/add_lost_item";
const String retreiveAllLostItems = "$url/retreive_all_lost_items";
